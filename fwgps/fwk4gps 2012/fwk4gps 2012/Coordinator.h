...
class Coordinator : public iCoordinator {
	...
	unsigned			   lastConsoleToggle;// time of most recent console toggle
  ...
  public:
	...
	// adds messageCentre to coordinator
	void  add(Console* m) { console = m; }
	...
	void  remove(Console *m)	   { console = 0; }
};
