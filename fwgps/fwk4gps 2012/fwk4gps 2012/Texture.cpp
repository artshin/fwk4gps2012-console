...
/*
iTexture* CreateTexture(const wchar_t* file, unsigned char* opac, unsigned filter) {

	return new Texture(file,opac, filter);
}
*/
...
/*
Texture::Texture(const wchar_t* file, unsigned char* opac, unsigned filter){
	Texture(file,filter);
